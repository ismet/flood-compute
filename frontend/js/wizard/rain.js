...
layers.thiessen = L.geoJSON(null, { style: { color: "#7d6e4f", weight: 1.5, fillOpacity: .05, dashArray: "3 3" } }).addTo(map);

// Thiessen style will be updated via recolorThiessen (dynamic)
export const RAIN_BLUES = ["#e3f2fd", "#bbdefb", "#90caf9", "#64b5f6", "#42a5f5",
